...
public class WebSocketHander implements WebSocketHandler {
    ...
    public void handleMessage(WebSocketSession webSocketSession, WebSocketMessage<?> webSocketMessage)
        ...
        System.out.println("-----------处理消息-----------" +webSocketMessage.getPayload());
        webSocketSession.sendMessage(new TextMessage(webSocketMessage.getPayload() + ""));
        webSocketSession.sendMessage(new TextMessage( "发送通知11"));
        webSocketSession.sendMessage(new TextMessage( "发送通知22"));
        webSocketSession.sendMessage(new TextMessage( "发送通知33"));
